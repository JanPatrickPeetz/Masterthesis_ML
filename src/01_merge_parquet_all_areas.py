...
merged_df = merged_df[(merged_df['tpep_pickup_datetime'] < "2023-04-01 00:00:00")] #lösche alle Daten nach 2023-04-01
...
## Define output path
output_file_path = '/Users/paddy/Documents/GitHub/Masterthesis_ML/data/01_taxi_data_0322_0323_all_areas.parquet'

## Write to parquet
merged_df.to_parquet(output_file_path, engine='fastparquet')
merged_df.to_csv('/Users/paddy/Documents/GitHub/Masterthesis_ML/data/01_taxi_data_0322_0323_all_areas.csv')
